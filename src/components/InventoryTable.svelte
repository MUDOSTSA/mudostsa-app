  ...
  <div class="h-full relative w-full overflow-scroll">
    <table class="w-full border-collapse min-w-260 text-white rounded-lg">
      <thead class="bg-slate-800 sticky top-0 z-1">
        <tr>
          <th></th>
          <InventoryHeader headerTitle="ID" column="id" {sorting}
          ></InventoryHeader>
          <InventoryHeader headerTitle="Item" column="name" {sorting}
          ></InventoryHeader>
          <InventoryHeader headerTitle="Quantity" column="quantity" {sorting}
          ></InventoryHeader>
          <InventoryHeader headerTitle="Category" column="category" {sorting}
          ></InventoryHeader>
          <InventoryHeader headerTitle="Location" column="location" {sorting}
          ></InventoryHeader>
          <InventoryHeader
            headerTitle="Modified at"
            column="updated_at"
            {sorting}
          ></InventoryHeader>
        </tr>
